...
// Compute their difference: maxVal - minVal.
// Multiply the difference by k to get the final answer.
// Return the result as a long long to avoid overflow.
...
public:
    long long maxTotalValue(vector<int>& nums, int k) {
        ...
        long long total = (long long)maxVal - minVal;
        return total * k;
    }
};