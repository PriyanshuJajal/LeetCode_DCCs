...
//     If both w and h are positive, the rectangles overlap.
//     The largest square side that fits in this overlap is min(w , h).

// Track the maximum square side across all pairs.
// Return the square of that side length as the area.
