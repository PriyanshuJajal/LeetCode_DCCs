...
// 🚀 Approach (JAVA)
// Tokenization: Use StringTokenizer to split each version string by "." into a list of string tokens.
// Normalization: Iterate through both token lists simultaneously. If one list is shorter, treat missing values as 0.
// Comparison: Convert each token to an integer and compare:
//     If v1[i] > v2[i], return 1.
//     If v1[i] < v2[i], return -1.
//     If equal, continue to next segment.
// Result: If all segments are equal, return 0.
